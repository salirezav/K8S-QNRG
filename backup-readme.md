...
You must install a pod network add-on so that your pods can communicate with each other. I used [**Flannel**](t.ly/C79T).

the last command needs to be executed on the worker nodes.
...
to resolve 'port 53 is in use' problem:
[Go here](https://medium.com/@niktrix/getting-rid-of-systemd-resolved-consuming-port-53-605f0234f32f) -->